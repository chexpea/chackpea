...
░╚════╝░╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝╚═╝░░░░░╚══════╝╚═╝░░╚═╝                   
            ...
            \033[97m[!] https://github.com/chexpea/chackpea \n
...
def menu():
    ...
    [15]Steganography
    [16]More Tools 
    [17]Update or Uninstall | chackpea
    [99]Exit
    """)
    
    choice = input("chexpea  =>> ")
...
def ansurf():
    ...
    anc=input("[1]install [2]Run [3]Run With Timer [4]Stop [99]Main Menu >> ")
    if anc == "1":
        ...
        sure = input("Set Time for Automatic IP changer(second) >> ")
        os.system("sudo anonsurf start")
        os.system("clear")
...
def updatesys():
    choice = input("[1]Update System [2]Update chackpea [99]Back >> ")
    if choice == "1":
        os.system("sudo apt update && sudo apt full-upgrade -y")
        os.system("sudo apt-get install tor openssl curl && sudo apt-get update tor openssl curl ")
        os.system("sudo apt-get install python3-pip")
    elif choice == "2":
        os.system("sudo chmod +x /etc/;sudo chmod +x /usr/share/doc;sudo rm -rf /usr/share/doc/chackpea/;cd /etc/;sudo rm -rf /etc/chackpea/;mkdir chackpea;cd chackpea;git clone https://github.com/Z4nzu/chackpea.git;cd chackpea;sudo chmod +x install.sh;./install.sh")
    elif choice == "99":
        menu()
    else :
        menu()
...
def uninstall():
    ...
    if choice == "1":
        print("chackpea started to uninstall..")
        time.sleep(2)
        os.system("sudo chmod +x /etc/;sudo chmod +x /usr/share/doc;sudo rm -rf /usr/share/doc/chackpea/;cd /etc/;sudo rm -rf /etc/chackpea/;")
        time.sleep(3)
        print("chackpea Successfully Uninstall..")
        time.sleep(1)
        print("Happy Hacking..!!")
    elif choice == "99":
        update()
